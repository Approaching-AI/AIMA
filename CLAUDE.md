...
| linux-1 | `user@<REDACTED_IP>` (Tailscale) / `user@<REDACTED_IP>` (LAN) | Ubuntu 22.04 | x86_64 | 2× NVIDIA RTX 4090 48GB (Driver 550, CUDA) | 1 TB | 371 GB | Docker 28.0 | key | Dual-GPU inference validation |
